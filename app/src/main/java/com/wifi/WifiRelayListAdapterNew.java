...
public class WifiRelayListAdapterNew extends BaseAdapter {
	...
	public WifiRelayListAdapterNew(Context context, List<ScanResult> wifiList,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_wifi_child_new, null);
		}
